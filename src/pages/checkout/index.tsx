              ...
              <Grid container rowSpacing={2} sx={{ padding: "25px", border: "2px solid #eaeaea" }}>
                ...
                <Grid item xs={12}>
                  <Box sx={addressTitleStyles} onClick={displayAddressesToggler}>
                    <Typography component="h4">ارسال به آدرس متفاوت</Typography>
                    <Add className="icon" />
                  </Box>
                ...
                <Grid item xs={12}>
                  <FormGroup>
                    <StyledFormControlLabel control={<Checkbox onChange={couponToggler} />} label="کد تخفیف دارید؟" />
                  </FormGroup>
                  <Divider sx={{ width: "97%", mt: "4px", mb: "20px" }} />
            ...
            <Grid item xs={12} md={6}>
              <Grid container rowSpacing={2} sx={{ padding: "25px", border: "2px solid #eaeaea" }}>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    اطلاعات شخصی و پرداخت شما طبق قوانین حریم شخصی وین گیم، محفوظ می ماند
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Button
                  ...
                  >
                    {selectedPaymentMethod === "cash" ? "سفارش" : "پرداخت آنلاین"}
                  </Button>
                </Grid>
              </Grid>
            </Grid>
