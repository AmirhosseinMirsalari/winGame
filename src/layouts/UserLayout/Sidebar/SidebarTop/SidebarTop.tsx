...
import { userAvatarStyle,UserNavItem,topMenuItem } from "../../../../../styles/user";
      ...
      <Box sx={{ position: "relative" }}>
        <UserNavItem>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <Box
              sx={userAvatarStyle}
              id="user-button"
              onClick={() => navigate.push("/user/personal-info")}
            >
              <img
                src={
                  user?.image ||
          ...
          <EditIcon
            sx={{ color: "common.digitaRed", cursor: "pointer" }}
            onClick={() => navigate.push("/user/personal-info")}
          />
        </UserNavItem>
        ...
        <UserNavItem>
          <Box sx={{ paddingLeft: ".3rem" }}>
            <Typography>کیف پول</Typography>
            <Typography sx={topMenuItem}>
              <Box sx={{ display: "flex", alignItems: "center",fontSize:"14px",marginTop:"5px" }}>
                افزایش کیف پول
                <KeyboardArrowLeftIcon className="navIcon" />
              </Box>
            </Typography>
          </Box>
