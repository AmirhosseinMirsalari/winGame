...
function Toolbar({
  ...
  const selectedSortingHandler = (event: SelectChangeEvent) => {
    ...
    if (value) {
      router.push(`/shop?sort=${value}`, undefined, { shallow: false });
    } else {
      router.push("/shop", undefined, { shallow: false });
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <Button
          startIcon={
            <FilterList sx={{ fontSize: "25px", marginLeft: "10px" }} />
          }
        ...
        >
          ...
          <ToolbarButton
            ...
            onClick={() => {
              ...
              router.push(`/shop?limit=12`, undefined, {
                shallow: false,
              });
            }}
          >
          ...
          <ToolbarButton
            ...
            onClick={() => {
              ...
              router.push(`/shop?limit=24`, undefined, {
                shallow: false,
              });
            }}
          >
          ...
          /
          <ToolbarButton
            className={productsPerPage == 200 ? "active" : ""}
            onClick={() => {
              setProductsPerPage(200);
              router.push(`/shop?limit=31`, undefined, {
                shallow: false,
              });
            }}
          >
