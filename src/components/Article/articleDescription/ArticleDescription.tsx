    ...
    <Box display="flex" flexDirection="row" flexWrap="wrap" alignItems="flex-end">
      ...
      <Item>
        <Box display="flex" alignItems="center">
          <PersonOutlineOutlinedIcon style={{ fontSize: "15px" }} color="secondary" />
          <Link
            href="#"
            underline="none"
            color="secondary"
      ...
      <Item>
        <Box display="flex">
          &nbsp;
          <AccessTimeOutlinedIcon style={{ fontSize: "15px" }} color="secondary" />
          &nbsp;{date} -
        </Box>
      </Item>
      {/* category article */}
      ...
      <Item>
        <Box display="flex" alignItems="center">
          &nbsp;
          <ModeCommentOutlinedIcon style={{ fontSize: "15px" }} color="secondary" />
          <Link
            href="#"
            underline="none"
            color="secondary"
